...
Item {
    ...
    function startWork() {
        ...
        // Activate Do Not Disturb when starting work
    ...
    function startBreak() {
        ...
        // Deactivate Do Not Disturb when starting break
    ...
    function pause() {
        if (internalStage !== "idle") {
            ...
            // Deactivate Do Not Disturb when pausing work
            if (isPaused && internalStage === "work") {
                Config.doNotDisturb = false
            }
            // Re-activate Do Not Disturb when resuming work
            else if (!isPaused && internalStage === "work") {
                Config.doNotDisturb = true
            }
        }
    }
    ...
    function stop() {
        ...
        // Deactivate Do Not Disturb when stopping
        Config.doNotDisturb = false
    }
