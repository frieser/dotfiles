...
MouseArea {
    ...
    readonly property bool isBreakOrPaused: pomodoroController.stage.includes("break") || pomodoroController.stage === "paused"
    ...
    Rectangle {
        id: timerContainer
        anchors.fill: parent
        color: root.isBreakOrPaused ? Qt.rgba(1, 1, 1, 0.06) : "transparent"
        radius: Config.itemRadius
        clip: true

        Behavior on color { ColorAnimation { duration: Config.animationDurationMedium } }
