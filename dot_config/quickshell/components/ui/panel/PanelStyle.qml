...
import "../../config" // Import components module (Config)
import ".."
...
Item {
    ...
    // Power change highlight indicator
    property bool powerChangeHighlight: false
    ...
    Rectangle {
        ...
        // Power change highlight border
        border.width: root.powerChangeHighlight ? 3 : 0
        border.color: root.powerChangeHighlight ? Config.accent : "transparent"
